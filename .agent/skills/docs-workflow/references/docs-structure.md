...
documentation workflows that must work at multiple scales.
...
The workflow operates at four scales. The principles and frontmatter spec are identical
...
The workflow detects scale by counting existing docs and examining the scope input.
